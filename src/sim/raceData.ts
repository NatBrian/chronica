...
export const RACE_TABLE: Record<Race, RaceStats> = {
  [Race.Human]: {
    breedChanceNum: 34, farmSkill: 130, forestYield: 90, mineSkill: 90, craftSkill: 100,
  ...
  [Race.Elf]: {
    breedChanceNum: 15, farmSkill: 95, forestYield: 150, mineSkill: 70, craftSkill: 110,
  ...
  [Race.Dwarf]: {
    breedChanceNum: 21, farmSkill: 65, forestYield: 80, mineSkill: 170, craftSkill: 160,
  ...
  [Race.Orc]: {
    breedChanceNum: 40, farmSkill: 75, forestYield: 85, mineSkill: 100, craftSkill: 70,
